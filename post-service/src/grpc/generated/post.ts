...
function createBaseMediaTag(): MediaTag {
  return { mediaId: "", userIds: [] };
}

export const MediaTag: MessageFns<MediaTag> = {
  encode(message: MediaTag, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.mediaId !== "") {
      writer.uint32(10).string(message.mediaId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MediaTag {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMediaTag();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  toJSON(message: MediaTag): unknown {
    const obj: any = {};
    if (message.mediaId !== "") {
      obj.mediaId = message.mediaId;
    }
  ...
  create<I extends Exact<DeepPartial<MediaTag>, I>>(base?: I): MediaTag {
    return MediaTag.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MediaTag>, I>>(object: I): MediaTag {
    const message = createBaseMediaTag();
    message.mediaId = object.mediaId ?? "";
...
function createBaseSubmitPostRequest(): SubmitPostRequest {
  return { content: "", userId: "", mediaIds: [], visibility: "", commentControl: "", mediaTags: [] };
}
...
export const SubmitPostRequest: MessageFns<SubmitPostRequest> = {
  encode(message: SubmitPostRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.mediaTags) {
      MediaTag.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
export const GetPostStatsResponse: MessageFns<GetPostStatsResponse> = {
  ...
  fromJSON(object: any): GetPostStatsResponse {
    return {
      totalPosts: isSet(object.totalPosts) ? globalThis.Number(object.totalPosts) : 0,
      reportedPosts: isSet(object.reportedPosts) ? globalThis.Number(object.reportedPosts) : 0,
      hiddenPosts: isSet(object.hiddenPosts) ? globalThis.Number(object.hiddenPosts) : 0,
      deletedPosts: isSet(object.deletedPosts) ? globalThis.Number(object.deletedPosts) : 0,
      createdToday: isSet(object.createdToday) ? globalThis.Number(object.createdToday) : 0,
      createdThisWeek: isSet(object.createdThisWeek) ? globalThis.Number(object.createdThisWeek) : 0,
      createdThisMonth: isSet(object.createdThisMonth) ? globalThis.Number(object.createdThisMonth) : 0,
      totalComments: isSet(object.totalComments) ? globalThis.Number(object.totalComments) : 0,
      reportedComments: isSet(object.reportedComments) ? globalThis.Number(object.reportedComments) : 0,
      deletedComments: isSet(object.deletedComments) ? globalThis.Number(object.deletedComments) : 0,
      createdTodayComments: isSet(object.createdTodayComments) ? globalThis.Number(object.createdTodayComments) : 0,
      totalLikes: isSet(object.totalLikes) ? globalThis.Number(object.totalLikes) : 0,
      totalShares: isSet(object.totalShares) ? globalThis.Number(object.totalShares) : 0,
    };
  },
