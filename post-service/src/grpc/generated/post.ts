...
export interface GetPostStatsRequest {
}
...
export interface GetPostStatsResponse {
  ...
  createdTodayComments: number;
  totalLikes: number;
  totalShares: number;
}

/** Restore post version response */
  ...
  fromJSON(object: any): EditPostRequest {
    return {
      ...
      addAttachmentIds: globalThis.Array.isArray(object?.addAttachmentIds)
        ...
        ? object.add_attachment_ids.map((e: any) => globalThis.String(e))
        : [],
      removeAttachmentIds: globalThis.Array.isArray(object?.removeAttachmentIds)
        ...
        ? object.remove_attachment_ids.map((e: any) => globalThis.String(e))
        : [],
      idempotencyKey: isSet(object.idempotencyKey)
        ? globalThis.String(object.idempotencyKey)
        : isSet(object.idempotency_key)
...
function createBaseGetPostStatsRequest(): GetPostStatsRequest {
  return {};
}

export const GetPostStatsRequest: MessageFns<GetPostStatsRequest> = {
  encode(_: GetPostStatsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetPostStatsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetPostStatsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): GetPostStatsRequest {
    return {};
  },

  toJSON(_: GetPostStatsRequest): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<GetPostStatsRequest>, I>>(base?: I): GetPostStatsRequest {
    return GetPostStatsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetPostStatsRequest>, I>>(_: I): GetPostStatsRequest {
    const message = createBaseGetPostStatsRequest();
    return message;
  },
};

function createBaseGetPostStatsResponse(): GetPostStatsResponse {
  return {
    totalPosts: 0,
    reportedPosts: 0,
    hiddenPosts: 0,
    ...
    reportedComments: 0,
    deletedComments: 0,
    createdTodayComments: 0,
    totalLikes: 0,
    totalShares: 0,
  };
}

export const GetPostStatsResponse: MessageFns<GetPostStatsResponse> = {
  encode(message: GetPostStatsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.totalPosts !== 0) {
      writer.uint32(8).int32(message.totalPosts);
    }
    if (message.reportedPosts !== 0) {
      writer.uint32(16).int32(message.reportedPosts);
    }
    if (message.hiddenPosts !== 0) {
      writer.uint32(24).int32(message.hiddenPosts);
    }
    if (message.deletedPosts !== 0) {
      writer.uint32(32).int32(message.deletedPosts);
    }
    if (message.createdToday !== 0) {
      writer.uint32(40).int32(message.createdToday);
    }
    if (message.createdThisWeek !== 0) {
      writer.uint32(48).int32(message.createdThisWeek);
    }
    if (message.createdThisMonth !== 0) {
      writer.uint32(56).int32(message.createdThisMonth);
    }
    if (message.totalComments !== 0) {
      writer.uint32(64).int32(message.totalComments);
    }
    if (message.reportedComments !== 0) {
      writer.uint32(72).int32(message.reportedComments);
    }
    if (message.deletedComments !== 0) {
      writer.uint32(80).int32(message.deletedComments);
    }
    if (message.createdTodayComments !== 0) {
      writer.uint32(88).int32(message.createdTodayComments);
    }
    if (message.totalLikes !== 0) {
      writer.uint32(96).int32(message.totalLikes);
    }
    if (message.totalShares !== 0) {
      writer.uint32(104).int32(message.totalShares);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetPostStatsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetPostStatsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.reportedPosts = reader.int32();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.hiddenPosts = reader.int32();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.deletedPosts = reader.int32();
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.createdToday = reader.int32();
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.createdThisWeek = reader.int32();
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.createdThisMonth = reader.int32();
          continue;
        }
        case 8: {
          if (tag !== 64) {
        ...
        case 9: {
          ...
          message.reportedComments = reader.int32();
          continue;
        }
        case 10: {
          if (tag !== 80) {
          ...
          message.deletedComments = reader.int32();
          continue;
        }
        case 11: {
          if (tag !== 88) {
          ...
          message.createdTodayComments = reader.int32();
          continue;
        }
        case 12: {
          if (tag !== 96) {
          ...
          message.totalLikes = reader.int32();
          continue;
        }
        case 13: {
          if (tag !== 104) {
          ...
          message.totalShares = reader.int32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetPostStatsResponse {
    return {
      totalPosts: isSet(object.totalPosts)
        ? globalThis.Number(object.totalPosts)
        : isSet(object.total_posts)
        ? globalThis.Number(object.total_posts)
        : 0,
      reportedPosts: isSet(object.reportedPosts)
        ? globalThis.Number(object.reportedPosts)
        : isSet(object.reported_posts)
        ? globalThis.Number(object.reported_posts)
        : 0,
      hiddenPosts: isSet(object.hiddenPosts)
        ? globalThis.Number(object.hiddenPosts)
        : isSet(object.hidden_posts)
        ? globalThis.Number(object.hidden_posts)
        : 0,
      deletedPosts: isSet(object.deletedPosts)
        ? globalThis.Number(object.deletedPosts)
        : isSet(object.deleted_posts)
        ? globalThis.Number(object.deleted_posts)
        : 0,
      createdToday: isSet(object.createdToday)
        ? globalThis.Number(object.createdToday)
        : isSet(object.created_today)
        ? globalThis.Number(object.created_today)
        : 0,
      createdThisWeek: isSet(object.createdThisWeek)
        ? globalThis.Number(object.createdThisWeek)
        : isSet(object.created_this_week)
        ? globalThis.Number(object.created_this_week)
        : 0,
      createdThisMonth: isSet(object.createdThisMonth)
        ? globalThis.Number(object.createdThisMonth)
        : isSet(object.created_this_month)
        ? globalThis.Number(object.created_this_month)
        : 0,
      totalComments: isSet(object.totalComments)
        ? globalThis.Number(object.totalComments)
        : isSet(object.total_comments)
        ? globalThis.Number(object.total_comments)
        : 0,
      reportedComments: isSet(object.reportedComments)
        ? globalThis.Number(object.reportedComments)
        : isSet(object.reported_comments)
        ? globalThis.Number(object.reported_comments)
        : 0,
      deletedComments: isSet(object.deletedComments)
        ? globalThis.Number(object.deletedComments)
        : isSet(object.deleted_comments)
        ? globalThis.Number(object.deleted_comments)
        : 0,
      createdTodayComments: isSet(object.createdTodayComments)
        ? globalThis.Number(object.createdTodayComments)
        : isSet(object.created_today_comments)
        ? globalThis.Number(object.created_today_comments)
        : 0,
      totalLikes: isSet(object.totalLikes)
        ? globalThis.Number(object.totalLikes)
        : isSet(object.total_likes)
        ? globalThis.Number(object.total_likes)
        : 0,
      totalShares: isSet(object.totalShares)
        ? globalThis.Number(object.totalShares)
        : isSet(object.total_shares)
        ? globalThis.Number(object.total_shares)
        : 0,
    };
  },

  toJSON(message: GetPostStatsResponse): unknown {
    const obj: any = {};
    if (message.totalPosts !== 0) {
      obj.totalPosts = Math.round(message.totalPosts);
    }
    if (message.reportedPosts !== 0) {
      obj.reportedPosts = Math.round(message.reportedPosts);
    }
    if (message.hiddenPosts !== 0) {
      obj.hiddenPosts = Math.round(message.hiddenPosts);
    }
    if (message.deletedPosts !== 0) {
      obj.deletedPosts = Math.round(message.deletedPosts);
    }
    if (message.createdToday !== 0) {
      obj.createdToday = Math.round(message.createdToday);
    }
    if (message.createdThisWeek !== 0) {
      obj.createdThisWeek = Math.round(message.createdThisWeek);
    }
    if (message.createdThisMonth !== 0) {
      obj.createdThisMonth = Math.round(message.createdThisMonth);
    }
    if (message.totalComments !== 0) {
      obj.totalComments = Math.round(message.totalComments);
    }
    if (message.reportedComments !== 0) {
      obj.reportedComments = Math.round(message.reportedComments);
    }
    if (message.deletedComments !== 0) {
      obj.deletedComments = Math.round(message.deletedComments);
    }
    if (message.createdTodayComments !== 0) {
      obj.createdTodayComments = Math.round(message.createdTodayComments);
    }
    if (message.totalLikes !== 0) {
      obj.totalLikes = Math.round(message.totalLikes);
    }
    if (message.totalShares !== 0) {
      obj.totalShares = Math.round(message.totalShares);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<GetPostStatsResponse>, I>>(base?: I): GetPostStatsResponse {
    return GetPostStatsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetPostStatsResponse>, I>>(object: I): GetPostStatsResponse {
    const message = createBaseGetPostStatsResponse();
    message.totalPosts = object.totalPosts ?? 0;
    message.reportedPosts = object.reportedPosts ?? 0;
    message.hiddenPosts = object.hiddenPosts ?? 0;
    message.deletedPosts = object.deletedPosts ?? 0;
    message.createdToday = object.createdToday ?? 0;
    message.createdThisWeek = object.createdThisWeek ?? 0;
    message.createdThisMonth = object.createdThisMonth ?? 0;
    message.totalComments = object.totalComments ?? 0;
    message.reportedComments = object.reportedComments ?? 0;
    message.deletedComments = object.deletedComments ?? 0;
    message.createdTodayComments = object.createdTodayComments ?? 0;
    message.totalLikes = object.totalLikes ?? 0;
    message.totalShares = object.totalShares ?? 0;
    return message;
  },
};
...
export const PostServiceService = {
  ...
  getPostStats: {
    path: "/social.post.v1.PostService/GetPostStats",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetPostStatsRequest): Buffer => Buffer.from(GetPostStatsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetPostStatsRequest => GetPostStatsRequest.decode(value),
    responseSerialize: (value: GetPostStatsResponse): Buffer =>
      Buffer.from(GetPostStatsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetPostStatsResponse => GetPostStatsResponse.decode(value),
  },
} as const;
...
export interface PostServiceServer extends UntypedServiceImplementation {
  ...
  getPostStats: handleUnaryCall<GetPostStatsRequest, GetPostStatsResponse>;
}
...
export interface PostServiceClient extends Client {
  ...
  getPostStats(
    request: GetPostStatsRequest,
    callback: (error: ServiceError | null, response: GetPostStatsResponse) => void,
  ): ClientUnaryCall;
  getPostStats(
    request: GetPostStatsRequest,
    metadata: Metadata,
