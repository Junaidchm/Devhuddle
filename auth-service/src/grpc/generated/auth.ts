...
export const GetProfileResponse: MessageFns<GetProfileResponse> = {
  encode(message: GetProfileResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.jobTitle !== "") {
      writer.uint32(82).string(message.jobTitle);
    }
    if (message.company !== "") {
      writer.uint32(90).string(message.company);
    }
    if (message.yearsOfExperience !== "") {
      writer.uint32(98).string(message.yearsOfExperience);
    }
    if (message.emailVerified !== false) {
      writer.uint32(104).bool(message.emailVerified);
    }
    if (message.coverImage !== "") {
      writer.uint32(114).string(message.coverImage);
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetProfileResponse>, I>>(object: I): GetProfileResponse {
    ...
    message.yearsOfExperience = object.yearsOfExperience ?? "";
    message.emailVerified = object.emailVerified ?? false;
...
export const UpdateProfileRequest: MessageFns<UpdateProfileRequest> = {
  encode(message: UpdateProfileRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.jobTitle !== "") {
      writer.uint32(66).string(message.jobTitle);
    }
    if (message.company !== "") {
      writer.uint32(74).string(message.company);
    }
    if (message.yearsOfExperience !== "") {
      writer.uint32(82).string(message.yearsOfExperience);
    }
    if (message.coverImage !== "") {
      writer.uint32(90).string(message.coverImage);
    }
    return writer;
  },
